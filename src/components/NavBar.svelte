<header class="p-4 dark:bg-gray-800 dark:text-gray-100">
	<div class="container flex justify-between h-16 mx-auto">
		<a rel="noopener noreferrer" href="#" aria-label="Back to homepage" class="flex items-center p-2">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-8 h-8 dark:text-cyan-400">
		...
		<ul class="items-stretch hidden space-x-3 lg:flex">
			<li class="flex">
				<a rel="noopener noreferrer" href="#" class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-cyan-400 dark:border-cyan-400">Link</a>
			</li>
			<li class="flex">
		...
		<div class="items-center flex-shrink-0 hidden lg:flex">
			...
			<button class="self-center px-8 py-3 font-semibold rounded dark:bg-cyan-400 dark:text-gray-900">Sign up</button>
		</div>
